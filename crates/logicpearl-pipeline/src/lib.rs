...
use logicpearl_core::{
    load_artifact_bundle, resolve_manifest_member_path, ArtifactKind, LogicPearlError, Result,
};
...
fn parse_document<T>(content: &str) -> Result<T>
where
...
mod tests {
    use super::{
        compose_pipeline, parse_document, OverridePipelineDefinition, OverrideRefinementAction,
        PipelineDefinition, PipelineStageKind,
    };
