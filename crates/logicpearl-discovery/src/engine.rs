...
use candidates::{
    best_immediate_candidate_rule, candidate_is_compound, candidate_rules,
    compare_candidate_priority, matches_candidate, rule_from_candidate_with_context,
};
#[cfg(test)]
use candidates::{
...
use scoring::{
    candidate_total_penalty, compare_candidate_set_score, score_candidate_set,
...
fn limit_rules_by_training_coverage(
    rows: &[DecisionTraceRow],
