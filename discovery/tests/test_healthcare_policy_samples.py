...
from logicpearl.domains.healthcare_policy.samples import (
    execute_sample_cases_for_policy,
    generate_sample_cases_for_policy,
)


def test_generate_and_execute_sample_cases_matches_gate_ir() -> None:
    ...
    gate = compile_healthcare_policy_to_gate_ir(final_spec)
    case_set = generate_sample_cases_for_policy(final_spec)
    summary = execute_sample_cases_for_policy(final_spec, gate, case_set)
